...
class ThemeHunk_Child_Notify{
	...
	function notify(){
        ...
        <p><?php _e( "Child theme inherit the style and functionality of parent theme, you can easily update the parent theme without losing its Customization. That's why we highly recommend you to use Child theme to make your site update proof.", 'novellite' ); ?></p>
        <a href="<?php echo esc_url('https://themehunk.com/child-theme/#novellite-child'); ?>" class="button" target="_blank"><?php _e('Get Child Theme Now','novellite') ?></a>
